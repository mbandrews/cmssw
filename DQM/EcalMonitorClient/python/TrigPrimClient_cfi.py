...
ecalTrigPrimClient = cms.untracked.PSet(
    ...
    MEs = cms.untracked.PSet(
        ...
        TTF4vMask = cms.untracked.PSet(
            ...
            otype = cms.untracked.string('Ecal3P'),
            btype = cms.untracked.string('TriggerTower'),
            description = cms.untracked.string('Summarizes whether a TT was masked in the TPGRecords, or had an instance of TT Flag=4.<br/>GRAY: Masked, no TTF4,<br/>RED: Masked, with TTF4,<br/>BLUE: Not Masked, with TTF4.')
        )
    )
)
